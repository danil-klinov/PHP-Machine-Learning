...
class Stamping {
	private $vowel = "аеЄиоуыэю€";
	private $regexPerfectiveGerunds = array(
		"(в|вши|вшись)$",
		"(ив|ивши|ившись|ыв|ывши|ывшись)$"
	);
	private $regexAdjective = "(ее|ие|ые|ое|ими|ыми|ей|ий|ый|ой|ем|им|ым|ом|его|ого|ему|ому|их|ых|ую|юю|а€|€€|ою|ею)$";
	private $regexParticiple = array(
		"(ем|нн|вш|ющ|щ)",
		"(ивш|ывш|ующ)"
	);
	private $regexReflexives = "(с€|сь)$";
	...
	private $regexNoun = "(а|ев|ов|ие|ье|е|и€ми|€ми|ами|еи|ии|и|ией|ей|ой|ий|й|и€м|€м|ием|ем|ам|ом|о|у|ах|и€х|€х|ы|ь|ию|ью|ю|и€|ь€|€)$";
	...
	public function removeEndings($regex, $region){
		...
		if (is_array($regex)) {
			if (preg_match('/.+[а|€]' . $regex[0] . '/u', $word)) {
